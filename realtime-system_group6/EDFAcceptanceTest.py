...
class EDFAcceptanceTest:
    def __init__(self, periodic_tasks, horizon_cap=200):
        ...
        # ---------- Blocking Time (EDF + non-preemptive) ----------
        # Worst-case blocking from lower-priority (later-deadline) jobs
        self.B = max(
            (p.exec_time for p in periodic_tasks),
            default=0
        )
    ...
    def accept(self, new_job, admitted_sporadic_jobs, now):
        ...
        admitted_sporadic_jobs: list of accepted hard sporadic jobs
        """
